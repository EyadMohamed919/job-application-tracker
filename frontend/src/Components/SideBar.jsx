...
{
    return(
        <div className="w-[20%] h-[80%] bg-white pb-56 m-auto mt-10 mr-10 ml-0 border-black overflow-hidden shadow-bottom-black border-2 border-solid rounded-lg flex flex-col justify-center items-center">
            ...
            flex-grow justify-center items-center text-lg text-black font-thin"><i class="fa-solid fa-house w-max text-sm flex justify-center items-center m-auto ml-0 mr-2"></i>Home</a>
            ...
            border-b-2 border-b-solid border-b-black 
            flex-grow justify-center items-center text-lg text-black font-thin"><i class="fa-solid fa-angles-up w-max text-sm flex justify-center items-center m-auto ml-0 mr-2"></i>Growth Hub</a>
        </div>
    );
}
